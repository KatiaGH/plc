...
that test. After the complete module finishes, all related outputs and relays
are returned to their safe states.
"""
...
def restore_all_di_paths_after_module(
    dut: DutRpcClient,
    hat: HatClient,
    bench: BenchConfig,
) -> Iterator[None]:
    """Restore every related HAT output and PLC relay after the module."""
    yield
